defmodule IgwetWeb.AddressControllerTest do
  ...
  @create_attrs %{city: "some city", city_district: "some city_district", country: "some country", country_region: "some country_region", entrance: "some entrance", house_number: "some house_number", island: "some island", level: "some level", name: "some name", postcode: "some postcode", road_base: "some road_base", staircase: "some staircase", state: "some state", state_district: "some state_district", suburb: "some suburb", unit_base: "some unit_base", world_region: "some world_region"}
  @update_attrs %{city: "some updated city", city_district: "some updated city_district", country: "some updated country", country_region: "some updated country_region", entrance: "some updated entrance", house_number: "some updated house_number", island: "some updated island", level: "some updated level", name: "some updated name", postcode: "some updated postcode", road_base: "some updated road_base", staircase: "some updated staircase", state: "some updated state", state_district: "some updated state_district", suburb: "some updated suburb", unit_base: "some updated unit_base", world_region: "some updated world_region"}
  @invalid_attrs %{city: nil, city_district: nil, country: nil, country_region: nil, entrance: nil, house_number: nil, island: nil, level: nil, name: nil, postcode: nil, road_base: nil, staircase: nil, state: nil, state_district: nil, suburb: nil, unit_base: nil, world_region: nil}
